...
- 게임 개발 설명
    ...
    2. 게임 목적 
        트럼프 카드로 하는 원카드 게임에 알파고와 같은
        인공지능 컴퓨터를 구현하여 졸업 작품을 완성하고자 함.

    3. 적용한 기술 및 전공
        a. 프론트 : 사용자 경험 디자인, 웹 프로그래밍, 모바일 프로그래밍
        b. 알고리즘 : 알고리즘, 공업통계, 공업수학, 통계학
        c. 백엔드 : 데이터베이스, 웹 프로그래밍
        d. 인공지능 : 딥러닝, 머신러닝, 인공지능, 데이터마이닝
